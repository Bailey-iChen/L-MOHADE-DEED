...
import time
class LMOHADE_100:
    def __init__(self,particals,max_,min_,thresh,mesh_div=10, LH=100, L=0.08):
    ...
    def done(self,cycle_):
        ...
        for i in range(cycle_):
            ...
            self.update_()
            self.cur_iter = i
            print('Iteration ', i, ' completed, L-MOHADE_th_100_new best_emission, L-MOHADE best_cost: ',
