...
class MultiPopulationLMOHADE:
    def __init__(self,particals,max_,min_,thresh,mesh_div=10, LH=10000, L=0.08):
        ...
        self.swarm3_size = particals // 3
        self.swarm2_size = particals - self.swarm1_size - self.swarm3_size
    ...
    def update_(self):
        ...
        self.in_swarm1 = update.archive_learning(self.in_swarm1, self.shrink, self.cur_iter, self.L,
        ...
        self.in_swarm2 = update.PolynomialMutation(self.in_swarm2, self.eta_c, self.eta_m, self.pm)

        # HGS operator for exploitation
        self.in_swarm3 = update.modifiedHGSoperator(self.in_swarm3, self.shrink, self.cur_iter, self.L,
    ...
    def done(self,cycle_):
        ...
        for i in range(cycle_):
            ...
            self.update_()
            self.cur_iter = i
            print('Iteration ', i, ' completed, mpms_hgs_ea best_emission, L-MOHADE best_cost: ',
