...
class Plot_pareto:
    ...
    def show(self,in_,fitness_,archive_in,archive_fitness,i):
        ...
        fig = plt.figure('Iteration ' + str(i + 1) + '')
        ...
        ax3.scatter(archive_fitness[:,0],archive_fitness[:,1],s=200, c='',edgecolors='red', marker=".",alpha = 1.0)
        plt.show()
        # plt.savefig('./img_txt_3000/'+str(i+1)+'.png')
