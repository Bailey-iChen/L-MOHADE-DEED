...
class MoDE:
    ...
    def update_(self):
        ...
        self.in_ = update.update_DEpos(self.in_,self.min_,self.max_,self.CR,self.STEP_LENGTH)
    ...
    def done(self,cycle_):
        ...
        for i in range(cycle_):
            ...
            print('Iteration ',i,' completed, MODE best_emission, MODE best_cost: ', np.min(self.fitness_g[:, 1]), np.min(self.fitness_g[:, 0]))
