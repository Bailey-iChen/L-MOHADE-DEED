...
class MOPPSO:
    ...
    def initialize(self):
        ...
        # self.v_ = init.init_v(self.particals,self.min_,self.max_)
        self.v_ = self.in_
    ...
    def update_(self):
        ...
        self.v_, self.delta_list = update.update_ppso_v(self.particals, self.v_,self.min_,self.max_,self.in_,self.in_p,self.in_g, self.delta_list)
