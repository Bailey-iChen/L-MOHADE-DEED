...
class MoHGS_001:
    ...
    def update_(self):
        ...
        self.in_ = update.update_animals_001(self.particals, self.fitness_, self.in_g, self.fitness_g, self.shrink, self.L,
    ...
    def done(self,cycle_):
        ...
        for i in range(cycle_):
            ...
            print('Iteration ',i,' completed, MOHGS_a=001 best_emission, MOHGS best_cost: ', np.min(self.fitness_g[:, 1]), np.min(self.fitness_g[:, 0]))
